...
# projection_object.NNLR_ElasticNet(dataset_filtered, patterns_filtered, 'retinaProject', .01, .01)
...
projection_object.featurePlots(dataset_filtered, [15, 35, 63, 64, 65, 75], 'retinaProject', 'retinaUMAP')